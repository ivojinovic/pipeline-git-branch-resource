...
get_lane_for_group_name original_pipeline.yaml $PARAM_APP_DEV_TEMPLATE_GROUP full_tab_for_dev_template.yaml
get_lane_for_group_name original_pipeline.yaml $PARAM_APP_HOT_TEMPLATE_GROUP full_tab_for_hot_template.yaml
