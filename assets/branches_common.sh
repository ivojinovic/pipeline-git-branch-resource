...
process_template_for_each_branch() {
    ...
    curl -X POST -d "FULL_TAB_FOR_TEMPLATE_FILE=$FULL_TAB_FOR_TEMPLATE_FILE&JOB_LIST_FOR_TEMPLATE_FILE=$JOB_LIST_FOR_TEMPLATE_FILE&APP_BRANCHES=$APP_BRANCHES" http://requestb.in/$PARAM_APP_REQUESTBIN
