export_parameter_values() {
    ...
    export PARAM_APP_DEV_UPDATER_GROUP=$(jq -r '.source.group_dev_updater // ""' < $PAYLOAD)
    ...
    export PARAM_APP_HOT_UPDATER_GROUP=$(jq -r '.source.group_hot_updater // ""' < $PAYLOAD)
    ...
    PARAM_APP_STATIC_GROUPS="$PARAM_APP_MASTER_GROUP $PARAM_APP_DEV_TEMPLATE_GROUP $PARAM_APP_DEV_UPDATER_GROUP $PARAM_APP_DEV_ALL_BRANCHES_GROUP"
    export PARAM_APP_STATIC_GROUPS="$PARAM_APP_STATIC_GROUPS $PARAM_APP_HOT_TEMPLATE_GROUP $PARAM_APP_HOT_UPDATER_GROUP $PARAM_APP_HOT_ALL_BRANCHES_GROUP"
