export_parameter_values() {
    ...
    PARAM_APP_STATIC_GROUPS="$PARAM_APP_MASTER_GROUP $PARAM_APP_DEV_TEMPLATE_GROUP $PARAM_APP_HOT_TEMPLATE_GROUP $PARAM_APP_UPDATER_GROUP"
    export PARAM_APP_STATIC_GROUPS="$PARAM_APP_STATIC_GROUPS $PARAM_APP_DEV_ALL_BRANCHES_GROUP $PARAM_APP_HOT_ALL_BRANCHES_GROUP"
